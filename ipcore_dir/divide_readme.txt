The following files were generated for 'divide' in directory
C:\Modeltech_pe_edu_10.4a\ALU\ipcore_dir\
...
C Simulation Generator:
   ...
   * divide/cmodel/floating_point_v6_1_bitacc_cmodel_lin.zip
   * divide/cmodel/floating_point_v6_1_bitacc_cmodel_lin64.zip
   * divide/cmodel/floating_point_v6_1_bitacc_cmodel_nt.zip
   * divide/cmodel/floating_point_v6_1_bitacc_cmodel_nt64.zip

Generate EJava outputs:
   Please see the core data sheet.

   * demo_tb/tb_divide.vhd
